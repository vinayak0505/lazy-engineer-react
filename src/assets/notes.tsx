const Notes = () => (
	<svg
		className="h-5 w-5 flex-shrink-0 fill-none transition duration-75"
		viewBox="0 0 24 24"
	...
	>
		<path
			...
			className="stroke-gray-500 group-hover:stroke-gray-900 dark:stroke-gray-400 dark:group-hover:stroke-white"
			strokeWidth="2"
			strokeLinecap="round"
