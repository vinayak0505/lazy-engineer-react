const Notes = () => (
	<svg
		className="flex-shrink-0 w-5 h-5 transition duration-75 fill-none"
		viewBox="0 0 24 24"
	...
	>
		<path
			...
			className="stroke-gray-500 dark:stroke-gray-400 group-hover:stroke-gray-900 dark:group-hover:stroke-white"
			strokeWidth="2"
			strokeLinecap="round"
